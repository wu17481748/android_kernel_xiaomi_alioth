...
make -j$(nproc --all) O=out \
                      ARCH=arm64 \
                      CC=$work_dir/kernel/prebuilts/clang-r445002/bin/clang \
                      CLANG_TRIPLE=aarch64-linux-gnu- \
                      CROSS_COMPILE=$work_dir/kernel/prebuilts/aarch64-linux-android-4.9/bin/aarch64-linux-android- \
                      CROSS_COMPILE_ARM32=$work_dir/kernel/prebuilts/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
